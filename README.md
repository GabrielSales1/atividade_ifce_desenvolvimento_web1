...
O objetivo do projeto é demonstrar a utilização de eventos JavaScript para:
- Interagir com o usuário
- Manipular formulários
- Atualizar dados em tela de forma dinâmica
- Confirmar ações críticas, como exclusão de registros
...
- Confirmação de exclusão utilizando `confirm()` do JavaScript
